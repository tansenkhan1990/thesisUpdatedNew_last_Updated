...
rules = pd.read_table('/home/mirza/PycharmProjects/frame_work/dataset/FB15k_noise_included/fb15k_rules_all_thresholded_rule.tsv', header=None).values
...
for rule in rules:
    ...
    if simplerule[0]==simplerule[4] and simplerule[2]==simplerule[6] and p!=s:
        singlerule = [simplerule[1],simplerule[5],0] #implication
        simplerules.append(singlerule)
        print('implication')
    if simplerule[0]==simplerule[6] and simplerule[2]==simplerule[4]and p!=s:
        singlerule = [simplerule[1],simplerule[5],1] # inverse
        simplerules.append(singlerule)
        inverse.append(singlerule)
        print('inverse')
    if simplerule[0]==simplerule[6] and simplerule[2]==simplerule[4]and p==s:
        singlerule = [simplerule[1],simplerule[5],2] # symmetric
        simplerules.append(singlerule)
