...
data_dir = '/home/mirza/PycharmProjects/frame_work/dataset/fb15k_new'
...
train = mapped_id_to_original_triples(data_train, entity_to_id, rel_to_id)
test = mapped_id_to_original_triples(data_test, entity_to_id, rel_to_id)
valid = mapped_id_to_original_triples(data_valid, entity_to_id, rel_to_id)
write_train_dir = os.path.join(save_data_dir, 'original_quadropoles.txt')
