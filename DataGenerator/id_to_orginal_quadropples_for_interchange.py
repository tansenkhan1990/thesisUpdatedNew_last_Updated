...
def mapped_id_to_original_fifthopoles(fifthopoles, entity_to_id, rel_to_id, loc_to_id, tm_to_id):
    """
    :param
    ...
    for i in range(len(quadropoles)):
        ...
        loc.append(loc_to_id[quadropoles[i][3]])
        tm.append(tm_to_id[quadropoles[i][4]])

        

    original_fifthopoles = np.c_[sub, rel, obj , loc, tm]
...
train_original = mapped_id_to_original_fifthopoles(train, entity_to_id, rel_to_id, loc_to_id, tm_to_id)
test_original = mapped_id_to_original_fifthopoles(test, entity_to_id, rel_to_id, loc_to_id, tm_to_id)
