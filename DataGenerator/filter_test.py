...
data_dir = '/home/tansen/my files/thesis/mirza_framework_for_rotateE/rule_learning_framework-master/dataset/yago3_10/mapped_two'

maindata = pd.read_table(os.path.join(data_dir,'train.txt'),header= None, dtype=str)
data = np.array(maindata).astype(str)
data = np.unique(data, axis=0)
write_to_txt_file(os.path.join(data_dir, 'train.txt'), data)
