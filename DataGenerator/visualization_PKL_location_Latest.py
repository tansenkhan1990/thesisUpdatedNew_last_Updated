...
location_array = [['Europe', ['France', 'Germany', 'Italy' , 'Spain', 'Sweden', 'Denmark', 'Belgium' , 'Netherlands' , 'Poland']],
                  ['Asia', ["People's_Republic_of_China" , 'India' , 'Japan' , 'Pakistan']],
                  ['Australia', ['Australia', 'New_Zealand']],
                  ['North_America', [ 'United_States_of_America' , 'Canada']],
                  ['South_America', ['Brazil' , 'Argentina']]
                  ]
df = pd.DataFrame(np.array(location_array))
df.columns = ['category', 'matched_entities']
df.to_pickle('/home/tansen/my_files/thesis_new_files/thesisUpdatedNew/dataset/Wikidata5/location_category_wise_entity_latest.pkl')
#wiki
