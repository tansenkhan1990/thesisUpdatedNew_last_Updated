...
rules = pd.read_table('/home/mirza/PycharmProjects/frame_work/dataset/kinship/kinship_train_rules_all_thresholded_rule.tsv', header=None).values
...
implication_data_dir = os.path.join(data_dir, 'rule_implication_test.txt')
inverse_data_dir = os.path.join(data_dir, 'rule_inverse_test.txt')
symmetric_data_dir = os.path.join(data_dir, 'rule_symmetric_test.txt')
equivalence_data_dir = os.path.join(data_dir, 'rule_equivalence_test.txt')
